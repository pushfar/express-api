 ...
 * @license Unlicensed
 */
export default class LogRequestResponse<T extends GlobalsType & { $services: { logger: Logger<T & { $client: { correlation: { id: string; userId?: string; companyId?: string; impersonatorId?: string } } }> } }> extends Middleware<T> {
	/**
	 * @public @method in
